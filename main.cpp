...
int main() {
    ...
    scene.addModel(dragon, glm::vec3(-2000, -285, 0), glm::vec3(750, 750, 750), glm::vec3(0.1, 0.1, 0.8), 0.6, 0);
    scene.addModel(dragon, glm::vec3(0, -265, 0), glm::vec3(1000, 1000, 1000), glm::vec3(0.8, 0.1, 0.1), 0.6, 0);
