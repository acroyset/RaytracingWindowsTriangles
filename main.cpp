...
int main() {
    ...
    Scene scene(width, height, 1,3, 12);

    Timer t;

    //scene.addModel("dragon800K.txt", glm::vec3(-1200, -929.502, 500), glm::vec3(100, 100, 100), glm::vec3(0.8, 0.6, 0.1), 0.6, 0);
    //scene.addModel("dragon800K.txt", glm::vec3(-1000, -859.004, 500), glm::vec3(200, 200, 200), glm::vec3(0.1, 0.8, 0.1), 0.6, 0);
    //scene.addModel("dragon800K.txt", glm::vec3(-630, -647.51, 500), glm::vec3(500, 500, 500), glm::vec3(0.1, 0.1, 0.8), 0.6, 0);
    //scene.addModel("dragon800K.txt", glm::vec3(0, -436.016, 500), glm::vec3(800, 800, 800), glm::vec3(0.8, 0.1, 0.1), 0.6, 0);
    scene.addModel("dragon800K.txt", glm::vec3(0, -265, 0), glm::vec3(100, 100, 100), glm::vec3(0.8, 0.6, 0.1), 0.8, 0);
