...
int main() {
    ...
    BaseModel dragon("models/sphere.txt");


    scene.addModel(dragon, glm::vec3(0,759.79, 0), glm::vec3(250, 250, 250), glm::vec3(0.8, 0.6, 0.1), 0, 0);
    scene.addModel(dragon, glm::vec3(-750, 550, 0), glm::vec3(200, 200, 200), glm::vec3(0.1, 0.8, 0.1), 0, 0);
    scene.addModel(dragon, glm::vec3(-1400, 450, 0), glm::vec3(150, 150, 150), glm::vec3(0.1, 0.1, 0.8), 0, 0);
    scene.addModel(dragon, glm::vec3(-1900, 350, 0), glm::vec3(100, 100, 100), glm::vec3(0.8, 0.1, 0.1), 0, 0);
